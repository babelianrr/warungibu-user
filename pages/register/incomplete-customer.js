...
import { Layout, FormInformation, FormOutlet, FormLicense, Verifikasi, CreateAddress, CustomerPin, CustomerPinConfirmation, CompleteCustomer } from '@/components/register'
import { fetchGet } from 'helpers/fetch'

export default function InclompleteCustomerRegister({ outletTypes }) {
  ...
  const maxWidth = 'p-4 w-full sm:max-w-xl'
